  ...
  <div className="outline">
    <div className="navRow">
      ...
      <div className="dropdown2">
        <button type="button" className="dropbtn2">
          STORE LOCATION
        </button>
      ...
      <div className="dropdown3">
        <button type="button" className="dropbtn3">
          ABOUT US
        </button>
      ...
      <div className="dropdown4">
        <button type="button" className="dropbtn4">
          SIGN UP | LOGIN
        </button>
      </div>
      <div className="dropdown5">
        <button type="button" className="dropbtn5">
          SHOPPING BAG
        </button>
        <div className="bag">
